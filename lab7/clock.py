...
left = pygame.image.load("C:\\Users\\Asus\\job\\lab7\\leftarm.png")
right = pygame.image.load("C:\\Users\\Asus\\job\\lab7\\rightarm.png")
main = pygame.transform.scale(pygame.image.load("C:\\Users\\Asus\\job\\lab7\\clock.png"), (800, 600))
...
while not done: 
    ...
    rotated_leftarm = pygame.transform.rotate(pygame.transform.scale(left, (41, 683)), -second_angle)
